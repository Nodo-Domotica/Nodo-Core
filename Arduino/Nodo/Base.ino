#define NODO_COMPATIBILITY   02  // Ophogen bij gewijzigde settings struct of nummering events/commando's. 
...
prog_char PROGMEM Cmd_1[]="Boot"; // Vast op positie 1 !
...
prog_char PROGMEM Cmd_39[]="Device";
