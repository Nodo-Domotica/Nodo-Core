...
#define DEVICE_15  // SignalAnalyzer  : Geeft bij een binnenkomend signaal informatie over de pulsen weer.
...
// Toepassing  :
  ...
  #define DEVICE_CORE_15 // SignalAnalyzer  : Geeft bij een binnenkomend signaal informatie over de pulsen weer.
