...
// hoger dan 15. Zolang deze plugin nog niet is aangepast moet de onderstaande regel in worden opgenomen in
// het Config_nn.c bestand:

#define PLUGIN_37_COMPATIBILITY true

// Deze regel maakt dat deze plugin tijdelijk compatibel wordt met de Nodo release 3.8. Hiervoor zal
